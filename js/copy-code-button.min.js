function createCopyButton(e){const t=document.createElement("button");t.className="copy-code-button",t.type="button",t.innerText="Copy",t.addEventListener("click",()=>copyCodeToClipboard(t,e)),e.insertBefore(t,e.firstChild);const n=document.createElement("div");n.className="highlight-wrapper",e.parentNode.insertBefore(n,e),n.appendChild(e)}document.querySelectorAll(".highlight").forEach(e=>createCopyButton(e));async function copyCodeToClipboard(e,t){let n=t.querySelector(":last-child > code").innerText;n=n.replace(/\n\n/g,`
