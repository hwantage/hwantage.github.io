var timelineData=[{id:"0",permalink:"https://hwantage.github.io/posts/hugo/",title:"HUGO를 이용한 정적 사이트 생성 및 github pages를 이용한 블로그 운영 방법",tags:["hugo","github pages","SSG","JAM Stack"],description:"SSG(Static Site Generator)를 생성 운영하는 방법에 대한 포스팅입니다. hugo 와 github pages를 이용합니다.",category:"[Front-end]",contents:`Agenda
...
`,date:"2024-01-12 13:14:52",type:"posts"},{id:"1",permalink:"https://hwantage.github.io/posts/nvm/",title:"nvm을 이용한 node.js의 버전 관리 방법",tags:["node","node.js","nvm"],description:"NVM(Node Version Manager)를 이용한 node  버전 관리 방법",category:"[Front-end]",contents:`새 노트북에서 node 를 설치후 기존에 잘 돌아가던 프로젝트를 빌드 하거나 실행하면 다음과 같은 에러가 발생하였다.
...
`,date:"2024-01-12 13:14:52",type:"posts"},{id:"2",permalink:"https://hwantage.github.io/posts/npm-publish/",title:"CSS-Deduplication part 3 (postcss 플러그인을 npmjs.org에 배포)",tags:["PostCSS","CSS deduplicate","npm 패키지 배포","postcss-delete-duplicate-selector","npm publish"],description:"postcss 플러그인을 npmjs에 배포하기",category:"[Front-end]",contents:`CSS-Deduplication part1(postcss 커스텀 스크립트를 이용한 CSS 중복 제거) 포스트를 통해 postcss 커스텀 스크립트로 CSS 중복을 제거하는 방법을 확인할 수 있습니다.
...
https://awesomejs.dev/
`,date:"2024-01-14 10:32:14",type:"posts"},{id:"3",permalink:"https://hwantage.github.io/posts/css-deduplicate-2/",title:"CSS-Deduplication part 2 (CSS 중복제거 플러그인 제작)",tags:["PostCSS","CSS deduplicate","npm 패키지 배포"],description:"postcss 커스텀 스크립트를 이용하여 CSS 중복 제거 커스텀 스크립트를 개선하고 이를 npm 패키지로 생성 하는 방법",category:"[Front-end]",contents:`이전 포스팅을 통해 postcss 커스텀 스크립트로 CSS 중복을 제거하는 방법을 확인할 수 있습니다.
...
다음 포스팅 확인하기
`,date:"2024-01-15 13:14:52",type:"posts"},{id:"4",permalink:"https://hwantage.github.io/posts/css-deduplicate/",title:"CSS-Deduplication part1 (postcss 커스텀 스크립트를 이용한 CSS 중복 제거)",tags:["PostCSS","CSS deduplicate","file merge"],description:"두 개의 CSS 파일을 하나의 파일로 병합하고, 중복을 제거합니다. 이후 최적화를 위한 압축을 수행합니다.",category:"[Front-end]",contents:`본 포스팅을 통해 postcss 를 이용하는 방법에 대해 배울 수 있습니다. 또한 원하는 플러그인이 없는 경우 custom 플러그인을 작성하는 방법을 학습할 수 있습니다.
...
`,date:"2024-01-16 11:14:52",type:"posts"},{id:"5",permalink:"https://hwantage.github.io/posts/symboliclink/",title:"심볼릭 링크로 마크다운 에디터로 업로드한 이미지 HUGO에서 바로 확인",tags:["Symbolic link","powershell","hugo","image","마크업 에디터"],description:"마크업 에디터를 통해 이미지를 붙여넣기 하면 링크 경로가 맞지 않아 심볼릭 링크를 생성하여 이미지가 정상적으로 뜨도록 설정해보자.",category:"[Front-end]",contents:`Vscode의 Extension 중 하나인 Markdown Editor 를 통해 WYSIWYG 방식으로 편집할 때 이미지를 붙여넣기 하면 마크업 에디터에서는 잘 보이지만 hugo server 로 서버를 띄워 확인해보면 경로가 맞지 않아 이미지가 뜨지 않게 된다.
설정 화면으로 이동하여
이미지 경로를 다음과 같이 설정한다.
...
`,date:"2024-01-16 13:14:52",type:"posts"},{id:"6",permalink:"https://hwantage.github.io/posts/fake-terminal/",title:"Xterm.js 를 이용한 fake terminal 웹 제작",tags:["Xterm.js","fake terminal"],description:"웹 사이트에서 fake terminal 제작하는 방법.",category:"[Front-end]",contents:`
...
`,date:"2024-01-19 10:29:50",type:"posts"},{id:"7",permalink:"https://hwantage.github.io/posts/google-analytics/",title:"HUGO 블로그에 구글 애널리틱스 연결하기",tags:["hugo","google analytics","구글 애널리틱스"],description:"구글 애널리틱스 계정을 생성하고 블로그에 방문하는 사용자 정보를 확인하기",category:"[Front-end]",contents:`HUGO를 통해 블로그를 생성하고 나서 과연 방문객이 얼마나 될지 궁금할 것이다.
...
이상입니다.
`,date:"2024-01-20 13:14:52",type:"posts"},{id:"8",permalink:"https://hwantage.github.io/posts/utterances/",title:"HUGO 블로그에 댓글 기능 연동",tags:["hugo","utterances","댓글 기능"],description:"utterances 서비스를 이용해 HUGO 블로그에 댓글 기능 달기",category:"[Front-end]",contents:`HUGO를 통해 블로그 포스트 하단에 댓글 기능을 연동하는 방법을 알아보겠습니다.
...
완료!
`,date:"2024-01-20 13:14:52",type:"posts"},{id:"9",permalink:"https://hwantage.github.io/posts/google-search-console/",title:"HUGO로 제작한 블로그를 구글 검색, 네이버 검색, 다음 검색에 노출시키기",tags:["hugo","google search console","naver search advisor","daum","sitemap.xml","robots.txt"],description:"검색엔진에 블로그 게시물을 노출시키는 방법을 정리합니다.",category:"[Front-end]",contents:`검색엔진에 노출이 되도록 블로그를 설정합니다.
...
`,date:"2024-01-21 11:14:52",type:"posts"},{id:"10",permalink:"https://hwantage.github.io/posts/js-destructuring-assignment/",title:"Javascript 비구조화 할당",tags:["JS","비구조화 할당"],description:"비구조화 할당(destructuring assignment) 구문은 배열이나 객체의 속성을 해체하여 그 값을 개별 변수에 담을 수 있게 하는 자바스크립트 표현식(expression)",category:"[Javascript]",contents:`정의 비구조화 할당(destructuring assignment) 구문은 배열이나 객체의 속성을 해체하여 그 값을 개별 변수에 담을 수 있게 하는 자바스크립트 표현식(expression)
...
deep copy &amp; 값 변경 &amp; 값 추가 const a = { a1 : 10, a2 : 20, a3 : 30, a4 : 40 }; // deep copy + 값 변경 const aCopy = { ...a, a3 : &#39;삼십&#39; }; console.log(aCopy); // {a1: 10, a2: 20, a3: &#39;삼십&#39;, a4: 40} const aCopy2 = { a3 : &#39;삼십&#39;, ...a }; // 순서를 바꾸면? console.log(aCopy2); // {a1: 10, a2: 20, a3: 30, a4: 40} // deep copy + 새로운 값 할당 const aCopy3 = { aFirst : 0, ...a }; console.log(aCopy3); // {aFirst: 0, a1: 10, a2: 20, a3: 30, a4: 40} const aCopy4 = { ...a, aLast : 999 }; // 순서를 바꾸면? console.log(aCopy4); // {a1: 10, a2: 20, a3: 30, a4: 40, aLast: 999} `,date:"2024-01-22 13:14:52",type:"posts"},{id:"11",permalink:"https://hwantage.github.io/posts/js-find/",title:"Javascript find, findIndex, filter",tags:["JS","find","findIndex","filter"],description:"Javascript 객체 탐색시 자주 사용하는 find, findIndex, filter 문법을 정리합니다.",category:"[Javascript]",contents:`find find() 메서드는 주어진 판별 함수를 만족하는 첫 번째 요소 의 값을 반환합니다. 그런 요소가 없다면 undefined를 반환합니다.
...
How? JSON.stringify() var hello = {&#34;name&#34;:&#34;hello&#34;}; var stringHello = JSON.stringify(hello); alert(stringHello) // {&#34;name&#34;:&#34;hello&#34;} console.log(typeof hello); // object console.log(typeof stringHello); // string 역직렬화(deserialization) JSON.parse() var hello = {&#34;name&#34;:&#34;hello&#34;}; var stringHello = JSON.stringify(hello); // serialization var objectHello = JSON.parse(stringHello); // deserialization alert(objectHello) // [object Object] console.log(typeof hello); // object console.log(typeof stringHello); // string console.log(typeof objectHello); // object `,date:"2024-01-22 14:14:52",type:"posts"},{id:"13",permalink:"https://hwantage.github.io/posts/js-template-literal/",title:"Javascript 템플릿 리터럴(Template literal)",tags:["JS","Template literal"],description:"ES6는 템플릿 리터럴(Template literal)이라고 불리는 새로운 문자열 표기법을 도입하였습니다. 템플릿 리터럴은 일반 문자열과 비슷해 보이지만, ‘ 또는 “ 같은 통상적인 따옴표 문자 대신 백틱(backtick) 문자 `를 사용합니다. 템플릿 리터럴은 + 연산자를 사용하지 않아도 간단한 방법으로 새로운 문자열을 삽입할 수 있는 기능을 제공합니다. 이를 문자열 인터폴레이션(String Interpolation)이라 합니다. 문자열 인터폴레이션은 ${}으로 표현식을 감싸 사용합니다.",category:"[Javascript]",contents:" ES6는 템플릿 리터럴(Template literal)이라고 불리는 새로운 문자열 표기법을 도입하였습니다. 템플릿 리터럴은 일반 문자열과 비슷해 보이지만, ‘ 또는 “ 같은 통상적인 따옴표 문자 대신 백틱(backtick) 문자 `를 사용합니다. 템플릿 리터럴은 + 연산자를 사용하지 않아도 간단한 방법으로 새로운 문자열을 삽입할 수 있는 기능을 제공합니다. 이를 문자열 인터폴레이션(String Interpolation)이라 합니다. 문자열 인터폴레이션은 ${}으로 표현식을 감싸 사용합니다.\nTemplate Literal 적용전\nfunction printStr(str) { console.log(&#39;String is &#39; + str + &#39; !&#39;) } Template Literal 적용\nfunction printStr(str) { console.log(`String is ${str} !`) } ",date:"2024-01-22 14:14:52",type:"posts"},{id:"14",permalink:"https://hwantage.github.io/posts/js-function/",title:"Javascript 함수 선언 방법과 호이스팅",tags:["JS","Function","Hoisting"],description:"Javascript 함수선언문 (Function Declaration)과 함수표현식 (Function expression)의 차이점을 알아보고 호이스팅(hoisting)에 대해 알아본다.",category:"[Javascript]",contents:`함수 선언 방법 함수선언문 (Function Declaration) // 일반적인 함수 선언 방법 function add(a, b) { return a + b } 함수표현식 (Function expression) // arrow function으로 함수표현식 선언 방법 const myFunc1 = () =&gt; { } // 매개변수가 없을 경우 const myFunc2 = x =&gt; { } // 매개변수가 한 개인 경우, 소괄호를 생략 가능 const myFunc3 = (x, y) =&gt; { } // 매개변수가 여러 개인 경우, 소괄호를 생략 불가 // Body 전개 방법 const myFunc4 = x =&gt; { return x * 2 } // single line block const myFunc5 = x =&gt; x * 2 // 함수 몸체가 한줄의 구문이라면 중괄호 생략 가능 const myFunc6 = () =&gt; { return { a: 1 }} const myFunc7 = () =&gt; ({ a: 1 }) // 위 표현과 동일. 객체 반환시는 소괄호를 사용. 호이스팅(hoisting) 예제 부터 보면
...
// 전개연산자 사용 const myFunc2 = (...arguments) =&gt; { console.log(arguments); // [1, 2, 3, 4] } myFunc2(1, 2, 3, 4); `,date:"2024-01-22 14:14:52",type:"posts"},{id:"15",permalink:"https://hwantage.github.io/posts/js-performance-coding/",title:"Javascript 성능 향상 코딩 팁",tags:["JS","Performance","성능"],description:"Javascript 코드 작성시 성능을 최적화 하는 방법",category:"[Javascript]",contents:`자바스크립트 성능 측정 방법 console.time console.time(0); // 여러가지 로직 수행 console.timeEnd(0); console.time(&#39;t1&#39;); // 다양한 로직 수행 console.timeEnd(&#39;t1&#39;); 0: 7468.280029296875 ms performance.now var t1 = performance.now(); // 여러가지 로직 수행 var t2 = performance.now(); console.log(&#34;소요 시간: &#34; + (t2 - t1) + &#39;ms&#39;) 소요 시간: 5976.399999976158ms console.time 이 더 사용하기 쉬우나 비표준이므로 디버깅 용도로만 사용할 것. 프로덕션 환경에서는 사용하지 않는 것이 좋다.
...
var target = document.getElementById(&#39;container&#39;); for (var i = 0 ; i &lt; 1000; i++){ var div = document.createElement(&#39;div&#39;); div.innerText = i; target.appendChild(div); // 1000번의 reflow 발생 } // =&gt; 아래와 같이 향상 var fragment = document.createDocumentFragment(); for (var i = 0 ; i &lt; 1000; i++){ var div = document.createElement(&#39;div&#39;); div.innerText = i; flagment.appendChild(div); } var target = document.getElementById(&#39;container&#39;); target.appendChild(flagment); // 1번의 reflow 발생 `,date:"2024-01-23 14:14:52",type:"posts"},{id:"16",permalink:"https://hwantage.github.io/posts/hugo-deploy-automation/",title:"HUGO 사이트 배포를 위한 배치 파일 생성",tags:["hugo","github pages","SSG","배치","auto deploy","commit"],description:"블로그를 Github 에 commit 하기 위해서는 우선 hugo 빌드를 수행하고 git add 명령어 및 커밋 메시지 작성후 push를 해야 합니다. 이 과정은 몇 번의 command 명령어를 입력해야 하기 때문에 귀찮고 번거로운 작업이 됩니다. 이 포스트에서는 이러한 과정을 배치 파일을 생성하여 한번의 명령어로 처리하는 방법을 소개하겠습니다.",category:"[Front-end]",contents:`블로그를 Github 에 commit 하기 위해서는 우선 hugo 빌드를 수행하고 git add 명령어 및 커밋 메시지 작성후 push를 해야 합니다. 이 과정은 몇 번의 command 명령어를 입력해야 하기 때문에 귀찮고 번거로운 작업이 됩니다. 이 포스트에서는 이러한 과정을 배치 파일을 생성하여 한번의 명령어로 처리하는 방법을 소개하겠습니다.
...
`,date:"2024-01-27 13:14:52",type:"posts"}]